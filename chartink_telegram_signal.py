...
buy_payload  = {"scan_clause": '''( {1339018} (  abs(  [0] 5 minute adx di positive( 14 ) -  [0] 5 minute adx di negative( 14 ) ) >  12 and( {cash} ( ( {cash} (  daily close >  25 and  daily close <  80 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  8000000 and  [0] 5 minute volume >  800000 and  daily volume >  8000000 ) ) or( {cash} (  daily close >  80 and  daily close <  150 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  7000000 and  [0] 5 minute volume >  700000 and  daily volume >  7000000 ) ) or( {cash} (  daily close >  150 and  daily close <  500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  5000000 and  [0] 5 minute volume >  500000 and  daily volume >  5000000 ) ) or( {cash} (  daily close >  500 and  daily close <  1500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  3000000 and  [0] 5 minute volume >  300000 and  daily volume >  3000000 ) ) or( {cash} (  daily close >  1500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  2000000 and  [0] 5 minute volume >  200000 and  daily volume >  2000000 ) ) ) ) and  abs(  [0] 5 minute high -  [0] 5 minute low ) >  [0] 5 minute low *  0.006 ) )'''}
