...
sell_payload = {"scan_clause": '''( {1339018} (  [0] 5 minute close *  [0] 5 minute volume >  450000000 and  abs(  [0] 5 minute close -  [0] 5 minute open ) >  [0] 5 minute low *  0.011 and  [0] 5 minute close <  900 ) )'''}
