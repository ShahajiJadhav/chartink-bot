...
buy_hammer_payload  = {"scan_clause": '''( {1339018} (  [0] 5 minute close >  [0] 5 minute open *  1.006 and( {cash} ( ( {cash} (  daily close >  25 and  daily close <  80 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  4000000 and  daily volume >  4000000 ) ) or( {cash} (  daily close >  80 and  daily close <  150 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  3000000 and  daily volume >  3000000 ) ) or( {cash} (  daily close >  150 and  daily close <  500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  2000000 and  daily volume >  2000000 ) ) or( {cash} (  daily close >  500 and  daily close <  1500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  1000000 and  daily volume >  1000000 ) ) or( {cash} (  daily close >  1500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  400000 and  daily volume >  400000 ) ) ) ) and  [0] 30 minute close >  [0] 30 minute low *  1.01 and( {cash} (  abs(  [-1] 5 minute close -  [-1] 5 minute open ) <  abs(  [-1] 5 minute high -  [-1] 5 minute low ) *  0.4 or  [-1] 5 minute close -  [-1] 5 minute open <  [-1] 5 minute open *  1.003 ) ) and  [0] 5 minute close >  [0] 5 minute supertrend( 18 , 1.1 ) ) )'''}
sell_hammer_payload = {"scan_clause": '''( {1339018} (  [0] 5 minute close <  [0] 5 minute open *  0.99 and  [0] 30 minute close <  [0] 30 minute high *  0.99 and( {cash} (  abs(  [-1] 5 minute close -  [-1] 5 minute open ) <  abs(  [-1] 5 minute high -  [-1] 5 minute low ) *  0.4 or  [-1] 5 minute open -  [-1] 5 minute close <  [-1] 5 minute close *  0.996 ) ) and  [0] 5 minute close <  [0] 5 minute supertrend( 18 , 1.1 ) and( {cash} ( ( {cash} (  daily close >  25 and  daily close <  80 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  4000000 and  daily volume >  4000000 ) ) or( {cash} (  daily close >  80 and  daily close <  150 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  3000000 and  daily volume >  3000000 ) ) or( {cash} (  daily close >  150 and  daily close <  500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  2000000 and  daily volume >  2000000 ) ) or( {cash} (  daily close >  500 and  daily close <  1500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  1000000 and  daily volume >  1000000 ) ) or( {cash} (  daily close >  1500 and  [0] 5 minute sum(  [0] 5 minute volume , 12 ) >  400000 and  daily volume >  400000 ) ) ) ) ) )'''}
