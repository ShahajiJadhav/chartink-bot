...
signal_payload = {"scan_clause": '''( {1339018} (  abs(  [0] 5 minute close -  [0] 5 minute open ) >  [0] 5 minute low *  0.007 and  [0] 5 minute volume *  [0] 5 minute close >  250000000 and( {cash} (  daily close >  15 and  daily close <  1500 ) ) ) )'''}
