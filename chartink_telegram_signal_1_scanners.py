...
signal_payload = {"scan_clause": '''( {1339018} (  abs(  [0] 5 minute close -  [0] 5 minute open ) >  [0] 5 minute low *  0.007 and  [0] 5 minute close *  [0] 5 minute volume >  250000000 and  [-1] 5 minute count( 18, 1 where  abs(  [-1] 5 minute close -  [-1] 5 minute open ) <  [-1] 5 minute low *  0.002 ) >  13 and  [-1] 5 minute sma(  [-1] 5 minute close *  [-1] 5 minute volume , 14 ) <  50000000 and  abs(  [0] 5 minute {custom_indicator_185281_start}"{custom_indicator_185278_start}"ema(  {custom_indicator_185277_start}"ema(  close - 1 candle ago close , 10 )"{custom_indicator_185277_end} , 26 )"{custom_indicator_185278_end} /  {custom_indicator_185280_start}"ema(  {custom_indicator_185279_start}"ema( abs(  close - 1 candle ago close ) , 10 )"{custom_indicator_185279_end} , 26 )"{custom_indicator_185280_end} * 100"{custom_indicator_185281_end} -  [-1] 5 minute {custom_indicator_185281_start}"{custom_indicator_185278_start}"ema(  {custom_indicator_185277_start}"ema(  close - 1 candle ago close , 10 )"{custom_indicator_185277_end} , 26 )"{custom_indicator_185278_end} /  {custom_indicator_185280_start}"ema(  {custom_indicator_185279_start}"ema( abs(  close - 1 candle ago close ) , 10 )"{custom_indicator_185279_end} , 26 )"{custom_indicator_185280_end} * 100"{custom_indicator_185281_end} ) >  10 and  [0] 5 minute close >  [0] 5 minute open ) )'''}
